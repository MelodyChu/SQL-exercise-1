...
SELECT o.id, status, order_total FROM orders o join customers c ON o.customer_id = c.id WHERE email='pclark74@gmail.com';
...
SELECT common_name, melon_type, quantity, unit_price, total_price FROM melons m join order_items o ON o.melon_id=m.id WHERE order_id=2725;
